...
$mysql_sslconnect = filter_var(getenv('DB_SSL_CONNECTION'), FILTER_VALIDATE_BOOLEAN);
if ($mysql_sslconnect && !is_numeric(strpos($connectstr_dbhost, "127.0.0.1")) && !is_numeric(strpos(strtolower($connectstr_dbhost), "localhost"))) {
 ...
 */
$wp_debug_env = getenv('WP_DEBUG');
define( 'WP_DEBUG', filter_var($wp_debug_env, FILTER_VALIDATE_BOOLEAN) );
